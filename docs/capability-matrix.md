...
| Matchmaking and admission | GameService + Agones | Queue/status/cancel, bounded allocation retries, stale-allocation and heartbeat-stale running-match recovery, authenticated server heartbeats, join claims, restrictions | Go integration suite; Kind/Agones smoke |
